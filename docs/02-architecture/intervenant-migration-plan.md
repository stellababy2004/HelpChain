...
- Source of truth: No
- Review required: Yes
- Notes: This document describes a migration strategy and may not reflect the current production state. Validate against the current data model, routes, and active flows before using it for implementation decisions.

## 1. Current State
- The canonical data model is documented in `docs/02-architecture/data-model.md`.
