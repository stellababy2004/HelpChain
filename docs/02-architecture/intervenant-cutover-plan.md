...
- Source of truth: No
- Review required: Yes
- Notes: Migration guidance only. This document may not reflect the current production state. Validate against the current data model, routes, and active flows before using it for implementation decisions.
