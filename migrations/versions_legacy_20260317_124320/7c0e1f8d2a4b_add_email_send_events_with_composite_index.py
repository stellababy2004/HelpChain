...
def downgrade():
    ...
    safe_drop_index(op, "ix_email_send_events_purpose", table_name="email_send_events")
    safe_drop_index(op, "ix_email_send_events_email_hash", table_name="email_send_events")
    safe_drop_index(op, "ix_email_send_events_created_at", table_name="email_send_events")
