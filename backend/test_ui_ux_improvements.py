...
class TestUIUXImprovements:
    ...
    def test_css_files_have_content(self):
        ...
        for css_file in css_files:
            with open(css_file, encoding="utf-8") as f:
                ...
                assert (
                    len(content) > 1000
                ), f"CSS file {css_file} has insufficient content"
                assert (
                    "/*" in content
                ), f"CSS file {css_file} should have header comment"
    ...
    def test_base_template_includes_css(self, client):
        ...
        for css_file in expected_css:
            assert (
                css_file in css_hrefs
            ), f"CSS file {css_file} not included in base template"
    ...
    def test_theme_toggle_exists(self, client):
        ...
        assert "bi" in theme_icon.get(
            "class", []
        ), "Theme icon should use Bootstrap Icons"
    ...
    def test_responsive_classes_exist(self):
        ...
        with open("static/css/design-system.css", encoding="utf-8") as f:
            ...
            assert re.search(
                r"@media.*max-width.*768px", design_content
            ), "Media query not found in design-system.css"
        ...
        with open("static/css/dashboard.css", encoding="utf-8") as f:
            ...
            for pattern in dashboard_patterns:
                assert re.search(
                    pattern, dashboard_content
                ), f"Dashboard pattern '{pattern}' not found in dashboard.css"
    ...
    def test_accessibility_features(self, client):
        ...
        assert (
            skip_link.get("href") == "#main-content"
        ...
        if main_content:
            assert (
                main_content.get("id") == "main-content"
    ...
    def test_css_custom_properties(self):
        ...
        for prop in required_properties:
            assert (
                prop in content
            ), f"CSS custom property {prop} not found in design-system.css"
    ...
    def test_theme_variables(self):
        ...
        for pattern in theme_patterns:
            assert re.search(
                pattern, content
            ), f"Theme pattern '{pattern}' not found in themes.css"
    ...
    def test_loading_states(self):
        ...
        for pattern in loading_patterns:
            assert re.search(
                pattern, content
            ), f"Loading pattern '{pattern}' not found in loading.css"
    ...
    def test_navigation_styles(self):
        ...
        for pattern in nav_patterns:
            assert re.search(
                pattern, content
            ), f"Navigation pattern '{pattern}' not found in navigation.css"
    ...
    def test_form_styles(self):
        ...
        for pattern in form_patterns:
            assert re.search(
                pattern, content
            ), f"Form pattern '{pattern}' not found in forms.css"
    ...
    def test_typography_styles(self):
        ...
        typography_patterns = [r"font-family", r"text-", r"display-", r"text-body"]

        for pattern in typography_patterns:
            assert re.search(
                pattern, content
            ), f"Typography pattern '{pattern}' not found in typography.css"
    ...
    def test_css_validity(self):
        ...
        for css_file in css_files:
            with open(css_file, encoding="utf-8") as f:
                ...
                ), f"CSS file {css_file} has unbalanced braces"
    ...
    def test_performance_considerations(self):
        ...
        for css_file in css_files:
            with open(css_file, encoding="utf-8") as f:
                ...
                ), f"CSS file {css_file} should support reduced motion"
