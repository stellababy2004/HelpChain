...
from models import (
    db, NotificationTemplate, NotificationQueue, Notification, 
    NotificationPreference, PushSubscription, Volunteer
)
...
class NotificationService:
    ...
    def _load_push_config(self) -> Dict[str, str]:
        ...
        return {
            ...
            'vapid_claims': {
                'sub': f"mailto:{os.getenv('MAIL_DEFAULT_SENDER', '')}"
            }
        }
    ...
    def create_template(self, name: str, type: str, category: str, 
                       subject: str = None, title: str = None, content: str = "",
                       variables: List[str] = None, **kwargs) -> NotificationTemplate:
    ...
    def queue_notification(self, template_name: str, recipient_email: str,
                          recipient_type: str = 'volunteer', recipient_id: int = None,
                          personalization_data: Dict[str, Any] = None,
                          priority: str = 'normal', scheduled_for: datetime = None) -> NotificationQueue:
    ...
    def process_queue(self, max_items: int = 100) -> Dict[str, int]:
        ...
        try:
            ...
            pending_items = NotificationQueue.query.filter(
                ...
                try:
                    ...
                    if success:
                        ...
                        if item.attempts >= item.max_attempts:
                            ...
                            item.status = 'pending'
                            item.next_retry = datetime.utcnow() + timedelta(minutes=item.attempts * 5)
                            stats['skipped'] += 1
    ...
    def _send_push_notification(self, recipient_id: int, title: str, 
                              content: str, template: NotificationTemplate) -> bool:
    ...
    def _create_in_app_notification(self, recipient_id: int, title: str, 
                                   content: str, template: NotificationTemplate) -> bool:
    ...
    def _create_notification_record(self, queue_item: NotificationQueue, 
                                   template: NotificationTemplate, rendered: Dict[str, str]):
...
def send_notification(template_name: str, recipient_email: str, 
                     personalization_data: Dict[str, Any] = None, **kwargs):
