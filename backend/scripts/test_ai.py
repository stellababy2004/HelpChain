...
def print_ai_config():
    ...
    try:
        ...
        for name, p in providers.items():
            ...
            print(
                f"  {name}: enabled={enabled}, api_key={'SET' if api_key else 'NOT SET'}, model={model}"
            )
...
if __name__ == "__main__":
    ...
    print("\nTips:")
    print(
        " - To enable OpenAI, set OPENAI_API_KEY in your environment or in the project instance config."
    )
    print(
