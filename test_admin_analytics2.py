...
def test_admin_analytics():
    ...
    if login_response.status_code == 302:
        ...
        if dashboard_url:
            ...
            # Now try to access analytics immediately after dashboard
            ...
            if analytics_response.status_code == 200:
                ...
                if "trendsChart" in content:
                    print("✓ Trends chart canvas found")
                if "categoryChart" in content:
                    print("✓ Category chart canvas found")
                if "predictionChart" in content:
                    print("✓ Prediction chart canvas found")
