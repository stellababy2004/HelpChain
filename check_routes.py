...
with app.app_context():
    ...
    # Filter admin routes
    admin_routes = [r for r in routes if "admin" in r["endpoint"] or "admin" in r["url"]]
    ...
    analytics_routes = [r for r in routes if "analytics" in r["endpoint"] or "analytics" in r["url"]]
    print("\nAnalytics routes:")
